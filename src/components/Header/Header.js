...
const Header = (props) => {
    return (
        <div className='items-center text-center bg-[#E9ECFF] grid grid-rows-1 md:grid-cols-2 md:grid-cols-2 py-10 px-[20px] md:px-[32px] xl:px-[72px] h-fit'>
