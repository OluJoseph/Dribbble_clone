        ...
        <div className='px-[20px] md:px-[32px] xl:px-[72px] pt-[72px]'>
            <div className="flex flex-wrap flex-col lg:flex-row lg:flex-nowrap gap-[40px] border-b-2 pb-16 border-slate-100">   
                <div className=' w-[256px] flex-initial'>
                    ...
                    <Svg pathClassNames={"hover:fill-[#ba366e] cursor-pointer"} color={"#ea4c89"} drawingPath={dribbble} width={"100"} viewBox={"0 0 76 19"} title={'Dribbble: the community for graphic design'} />
                    ...
                    <ul className='w-full flex flex-wrap gap-6 text-gray-700'>
                        <li>
                          <Svg pathClassNames={'cursor-pointer hover:fill-black transition-all'} drawingPath={ball} width={"20"} viewBox={"0 0 32 32"} svgClassNames={'icon fill-current'} title={'dribbble'}/> 
                        </li>
                        <li>
                          <Svg pathClassNames={'cursor-pointer hover:fill-black transition-all'} drawingPath={twitter} width={"20"} viewBox={"0 0 24 24"} svgClassNames={'icon fill-current'} title={'Twitter icon'} />
                        </li>
                        <li>
                          <Svg pathClassNames={'cursor-pointer hover:fill-black transition-all'} drawingPath={facebook} width={"20"} viewBox={"0 0 24 24"} svgClassNames={'icon fill-current'} title={'Facebook icon'} />
                        </li>
                        <li>
                          <Svg pathClassNames={'cursor-pointer hover:fill-black transition-all'} drawingPath={instagram} width={"20"} viewBox={"0 0 16 16"} svgClassNames={'icon fill-current'} title={'Instagram icon'} />
                        </li>
                        <li>
                          <Svg pathClassNames={'cursor-pointer hover:fill-black transition-all'} drawingPath={pinterest} width={"20"} viewBox={"0 0 24 24"} svgClassNames={'icon fill-current'} title={'Pinterest icon'} />
                        </li>
                    </ul>
                </div>
            ...
            <div className='px-2 py-8 md:py-10 flex flex-col gap-2 items-center md:flex-row justify-between text-[14px] text-gray-500'>
                ...
                <div className='flex flex-col-reverse items-center  md:flex-row gap-2 md:items-center'>
                    <p> <span className='text-gray-900 font-bold'>0</span> shots dribbbled</p>
                    <img data-src="https://cdn.dribbble.com/assets/dribbble-ball-icon-4e54c54abecf8efe027abe6f8bc7794553b8abef3bdb49cd15797067cf80ca53.svg" width="24px" height="24px" alt="Dribbble ball icon" src="https://cdn.dribbble.com/assets/dribbble-ball-icon-4e54c54abecf8efe027abe6f8bc7794553b8abef3bdb49cd15797067cf80ca53.svg"></img>
                </div>
            </div>
        </div>
